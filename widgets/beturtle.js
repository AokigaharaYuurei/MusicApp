...
export const BeTurtle = () => {
    ...
    return(
        <div className="px-9">
            <div className="px-11 py-10"><Title children="Стань черепашкой!"/></div>
            <div className="flex justify-between bg-[#111111] rounded-[20px] px-11 items-center">
            <div>
                <span className="text-[#51BA55] font-[Inter] text-[64px] font-bold">Шаг 1</span>
                <p className="text-[#C0C0C0] font-[Inter] font-light text-[40px]">Определи черепашку для боя</p>
                <div>
